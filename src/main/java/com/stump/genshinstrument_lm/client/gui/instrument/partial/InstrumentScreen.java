...
import com.stump.genshinstrument_lm.client.gui.instrument.GenshinConsentScreen;
...
public abstract class InstrumentScreen extends Screen {
    ...
    public static String getGlobalRootPath() {
        return "textures/gui/genshinstrument_lm/";
    }
    /**
     ...
     * It will usually be {@code textures/gui/genshinstrument_lm/instrument/<instrument>/}.
    ...
    protected Button initOptionsButton(final int vertOffset) {
        final Button button = Button.builder(
            Component.translatable("button.genshinstrument_lm.instrumentOptions").append("..."), (btn) -> onOptionsOpen()
        )
            .width(150)
            .build();
