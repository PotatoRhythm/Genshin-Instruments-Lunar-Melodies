...
public class BassGuitarScreen extends GridInstrumentScreen {
    public static final ResourceLocation INSTRUMENT_ID = new ResourceLocation(GInstrumentMod.MODID, "bass_guitar");

    @Override
    public SoundOption getSoundOption() {
        return ((BassGuitarOptionsScreen) optionsScreen)
    ...
    protected InstrumentOptionsScreen initInstrumentOptionsScreen() {
        return new BassGuitarOptionsScreen(this);
    }
